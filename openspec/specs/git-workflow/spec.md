...
- **THEN** the system SHALL push the session branch, create a PR with title `chore(proj-001): consolidate session 2026-02-18-04-40`, merge the PR, delete the remote branch, and pull main locally
